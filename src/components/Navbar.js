            ...
            <div className="container-fluid">
                ...
                <div className="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    {/* <div className="d-flex">
                        ...
                        <div className="bg-light round mx-2" onClick={() => { props.toggleMode('light') }} style={{ height: '20px', width: '20px', border:'2px solid black', cursor: 'pointer' }}></div>
                        <div className="bg-dark round mx-2" onClick={() => { props.toggleMode('dark') }} style={{ height: '20px', width: '20px', border:'2px solid red', cursor: 'pointer' }}></div>
                    </div> */}
